...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.action === "decodeBase64") {
        ...
        if (text) {
            ...
            span.innerText= Base64.decode(text);
            Object.assign(span.style, {
                backgroundColor: '#97dcff',
                paddingLeft: '6px',
                paddingRight: '6px',
                marginLeft: '6px',
                marginRight: '6px',
                boxShadow: '1px 1px 3px 1px #00000059',
                borderRadius: '4px'
            })
...
const Base64 = {
    ...
    isBase64: (e) => {
        try {
            return Base64.encode(Base64.decode(e)) === e;
        }
        catch(error) {
            return false
        }
